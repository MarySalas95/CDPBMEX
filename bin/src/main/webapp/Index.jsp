...
<html>
    ...
    <body background="img/Wallpaper10.jpg">
        <div id="contenedor">
                ...
                <div id="derecho">
                    ...
                    <div>
                        <p style="color: #869099; padding: .5rem; margin: 0; margin-top: 15px; font-size: 12px;">
                            © 2024 <a href="https://www.bellota.com/es-mx" style="color: #007bff; text-decoration: none; background-color: transparent;"> Bellota México </a>. Todos los derechos reservados.
                        </p>
                    </div>
                </div>
